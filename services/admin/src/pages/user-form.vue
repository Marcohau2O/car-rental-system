                        ...
                        <form @submit.prevent="submit" class="bg-white p-8 rounded shadow space-y-6">
                            ...
                            <div class="grid md:grid-cols-3 gap-4">
                                ...
                                <div>
                                    ...
                                    <div
                                        v-if="selectedRole"
                                        class="mt-4 bg-gray-50 border border-gray-200 rounded-lg p-4"
                                    >
                                        ...
                                        <span
                                            v-for="p in selectedRole.permisos"
                                            :key="p.id"
                            ...
                            <div class="flex gap-4 mt-6">
                                <button type="submit"
                                    class="flex-1 bg-blue-600 text-white py-2 rounded font-semibold hover:bg-blue-700">
